...
class TestDataSender:
    ...
    def test_send_simple_text(self):
    ...
    def test_send_multiline_text(self):
    ...
    def test_send_ctrl_c_with_spaces(self):
    ...
    def test_send_escape_with_spaces(self):
    ...
    def test_send_mixed_special_and_normal(self):
    ...
    def test_send_with_custom_encoding(self):
    ...
    def test_send_whitespace_only_lines(self):
    ...
    def test_send_partial_control_sequences(self):
